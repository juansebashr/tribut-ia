...
- **5% por mes o fracción de mes** del impuesto a cargo (máximo 150%).
- **10% por mes** tras emplazamiento de la DIAN (máximo 200%).
...
### Ejemplo de Cálculo vía API (`POST /api/v1/beneficios/calcular-sancion`)
