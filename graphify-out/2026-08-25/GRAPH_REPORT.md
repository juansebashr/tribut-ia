...
- services/beneficios.py
- session_store_base.py
- test_session_sync.py
- test_api_endpoints.py
- test_two_way_full_cycle.py
- common.py
- test_beneficios_and_go.py
- test_pj_calculator.py
- conciliar_exogena.py
- loader.py
- main.py
- test_skill_renta_pn.py
- run.py
- models/persona_natural.py
- test_rules_engine.py
- test_session_store_redis.py
- inyectar_tributia.py
- config.py
- models/persona_juridica.py
- liquidacion_pj.py
- liquidacion_pn.py
- test_calendario.py
...
- LIBRO SÉPTIMO - (Libro, Adicionado por el Art. 139 de la Ley 1819 de 2016)
- LIBRO CUARTO - IMPUESTOS DE TIMBRE NACIONAL
- LIBRO OCTAVO - (Libro, Sustituido por el Art. 74 de la Ley 2010 de 2019)
...
- test_comparacion_patrimonial.py
- Cuadrantes Diataxis
- README.md
...
- test_pn_calculator.py
- test_componente_inflacionario.py
- Skill: Declaración de Renta Personas Naturales (Colombia - F210)
- simular_articulo_73.py
- rules/graphify.md
...
- ARTÍCULO 320. CASO EN EL QUE SE PRESUME LA TRANSFERENCIA
- ARTÍCULO 321. CONCEPTOS, BASE GRAVABLE Y TARIFAS
- ARTÍCULO 324. EXENCIÓN A LAS REGALÍAS
...
- ARTÍCULO 405. LA RETENCIÓN ES REQUISITOS PARA LA ACEPTACIÓN DE LA DEUDA
...
- ARTÍCULO 741. RECURSO EQUIVOCADOS
...
- ARTÍCULO 799. RESPONSABILIDAD DE LOS BANCOS POR PAGO IRREGULAR DE CHEQUE FISCALES
...
- TÍTULO X: (Título ADICIONADO por el Art. 54 de la Ley 2277 de 2022)
...
- models/comparacion_patrimonial.py
- services/comparacion_patrimonial.py
- inyectar_session.py
- fiscol
...
- session_sync.py
- models/tributacion_pareja.py
- test_tributacion_pareja.py
- simulation.py
- services/tributacion_pareja.py
- models/iva.py
- models/retefuente.py
...
2. `LIBRO QUINTO - PROCEDIMIENTO TRIBUTARIO, SANCIONES Y ESTRUCTURA DE LA DIRECCION GENERAL DE IMPUESTOS NACIONALES` - 333 edges
3. `LIBRO TERCERO - IMPUESTO SOBRE LAS VENTAS` - 117 edges
4. `LIBRO PRIMERO - IMPUESTO SOBRE LA RENTA Y COMPLEMENTARIOS` - 79 edges
5. `LIBRO CUARTO - IMPUESTOS DE TIMBRE NACIONAL` - 42 edges
6. `LIBRO OCTAVO - (Libro, Sustituido por el Art. 74 de la Ley 2010 de 2019)` - 35 edges
7. `LIBRO SÉPTIMO - (Libro, Adicionado por el Art. 139 de la Ley 1819 de 2016)` - 26 edges
8. `LIBRO SEXTO - "` - 16 edges
9. `Catalogo Exhaustivo de Beneficios Tributarios para Personas Naturales en Colombia` - 13 edges
10. `Estatuto Tributario Nacional de Colombia` - 10 edges
...
Cohesion: 0.06
Nodes (30): DummyStore, get_state, is_disc, publish_event, reset_state, subscribe, test_beneficios_http_endpoints_success, test_beneficios_service_edge_cases (+22 more)

### Community 1 - "reconciliation.py"
Cohesion: 0.15
Nodes (12): CsvValidationError, ReconciliationItem, ReconciliationKpis, ReconciliationParseResponse, _clean_numeric_value, _detect_delimiter, download_csv_template, _generate_didactic_explanation (+4 more)

### Community 2 - "session_store.py"
Cohesion: 0.13
Nodes (14): InMemorySessionStore, RedisSessionStore, create_session_store, _get_channel, _get_client, _get_key, get_state, __init__ (+6 more)

### Community 3 - "test_reconciliation_ephemeral.py"
Cohesion: 0.14
Nodes (13): test_reconciliation_demo_endpoint, test_reconciliation_didactic_explanations_branches, test_reconciliation_empty_file_error_400, test_reconciliation_empty_raw_400, test_reconciliation_invalid_file_extension_error_400, test_reconciliation_invalid_numeric_types_error_422, test_reconciliation_missing_required_headers_error_422, test_reconciliation_number_formatting_edge_cases (+5 more)

### Community 4 - "schema.py"
Cohesion: 0.12
Nodes (16): BeneficioAuditoriaRules, CedulaGeneralRules, DeduccionesRules, DescuentosPJRules, GananciaOcasionalRules, LimiteConjuntoRules, PersonaJuridicaRules, PersonaNaturalRules (+8 more)

### Community 5 - "LIBRO PRIMERO - de este Estatuto"
Cohesion: 0.01
Nodes (370): ARTÍCULO 100. DETERMINACIÓN DE LA RENTA BRUTA EN CONTRATOS DE RENTA VITALICIA, ARTÍCULO 101. LAS SUMAS PAGADAS COMO RENTA VITALICIA SON DEDUCIBLES, ARTÍCULO 102. CONTRATOS DE FIDUCIA MERCANTIL, ARTÍCULO 104. REALIZACIÓN DE LAS DEDUCCIONES PARA LOS NO OBLIGADOS A LLEVAR CONTABILIDAD, ARTÍCULO 105. REALIZACIÓN DE LA DEDUCCIÓN PARA LOS OBLIGADOS A LLEVAR CONTABILIDAD, ARTÍCULO 106. VALOR DE LOS GASTOS EN ESPECIE, ARTÍCULO 107. LAS EXPENSAS NECESARIAS SON DEDUCIBLES, ARTÍCULO 108. LOS APORTES PARAFISCALES SON REQUISITO PARA LA DEDUCCIÓN DE SALARIOS (+362 more)

### Community 6 - "services/beneficios.py"
Cohesion: 0.07
Nodes (28): AjusteArticulo73Item, BeneficioAuditoriaRequest, BeneficioAuditoriaResponse, BeneficioItem, EscenarioComparativoInmueble, ItemTablaComponenteInflacionario, LiquidacionSancionRequest, LiquidacionSancionResponse (+20 more)

### Community 7 - "session_store_base.py"
Cohesion: 0.20
Nodes (9): SessionState, SessionStoreBase, _create_default_session, get_state, publish_event, reset_state, subscribe, unsubscribe (+1 more)

### Community 8 - "test_session_sync.py"
Cohesion: 0.22
Nodes (8): test_session_sync_cookie_auto_provisioning, test_session_sync_get_initial_default_state, test_session_sync_header_resolution, test_session_sync_multi_sessions_isolation, test_session_sync_partial_updates, test_session_sync_post_and_get_state, test_session_sync_reset, test_ui_alias_routes

### Community 9 - "test_api_endpoints.py"
Cohesion: 0.12
Nodes (16): test_api_calculate_pj, test_api_calculate_pn, test_api_calculate_simple, test_api_comparativa_simple, test_api_iva_endpoints, test_api_retefuente_endpoints, test_convert_uvt, test_favicon_endpoints (+8 more)

### Community 10 - "test_two_way_full_cycle.py"
Cohesion: 0.29
Nodes (6): calc_dv, js_get_num, test_api_pn_full_35pct_bracket_cycle, test_colombian_currency_mask_parsing_logic, test_colombian_dian_dv_algorithm, test_progressive_marginal_slices_integrity

### Community 11 - "common.py"
Cohesion: 0.33
Nodes (5): AuditTraceItem, ReconciliationItem, ReconciliationState, UvtConversionRequest, UvtConversionResponse

### Community 12 - "test_beneficios_and_go.py"
Cohesion: 0.13
Nodes (14): test_beneficio_auditoria_calculo, test_calcular_exencion_inmueble_afc_art311_1, test_calcular_inmueble_afc_frontend_aliases_and_art72, test_calcular_sancion_con_intereses_de_mora_compuestos, test_calcular_sancion_control_minima_10_uvt, test_calcular_sancion_correccion_voluntaria_con_reduccion, test_calcular_sancion_extemporaneidad_mensual, test_calcular_sancion_inexactitud_tarifas_y_procesos (+6 more)

### Community 13 - "test_pj_calculator.py"
Cohesion: 0.50
Nodes (3): test_persona_juridica_formulario_110_estandar, test_persona_juridica_sobretasa_financiera, test_persona_juridica_tasa_minima_ttd_gatillada

### Community 14 - "conciliar_exogena.py"
Cohesion: 0.40
Nodes (4): conciliar_transacciones_con_exogena, normalize_nit, parse_exogena_file, parse_facturas_electronicas
...
Cohesion: 0.50
Nodes (3): test_conciliacion_exogena_matching, test_consolidar_template_csv, test_format_cop_colombian_mask

### Community 18 - "run.py"
Cohesion: 0.50
Nodes (3): is_port_in_use, kill_process_on_port, main

### Community 21 - "test_session_store_redis.py"
Cohesion: 0.40
Nodes (4): _target, _test, test_redis_session_store_lifecycle_and_ttl, test_redis_session_store_pubsub_broadcast

### Community 24 - "models/persona_juridica.py"
Cohesion: 0.50
Nodes (3): Formulario110Casillas, PersonaJuridicaInput, PersonaJuridicaOutput

### Community 40 - "Cómo Analizar el Control por Comparación Patrimonial (Arts. 236 y 237 E.T.)"
Cohesion: 0.29
Nodes (6): 1. Fundamento Legal (Arts. 236 y 237 E.T.), 2. Fórmulas de Cálculo, 3. Ejemplo de Uso vía API REST, Cómo Analizar el Control por Comparación Patrimonial (Arts. 236 y 237 E.T.), Petición HTTP (`POST /api/v1/persona-natural/comparacion-patrimonial`), Respuesta

### Community 41 - "LIBRO QUINTO - PROCEDIMIENTO TRIBUTARIO, SANCIONES Y ESTRUCTURA DE LA DIRECCION GENERAL DE IMPUESTOS NACIONALES"
Cohesion: 0.01
Nodes (323): ARTÍCULO 20, ARTÍCULO 20, ARTÍCULO 51, ARTÍCULO 51, ARTÍCULO 52, ARTÍCULO 523, ARTÍCULO 54, ARTÍCULO 555. CAPACIDAD Y REPRESENTACIÓN (+315 more)

### Community 42 - "LIBRO TERCERO - IMPUESTO SOBRE LAS VENTAS"
Cohesion: 0.02
Nodes (113): ARTÍCULO 122, ARTÍCULO 420. HECHOS SOBRE LOS QUE RECAE EL IMPUESTO, ARTÍCULO 421. HECHOS QUE SE CONSIDERAN VENTA, ARTÍCULO 422. LOS BIENES RESULTANTES DE PROCESOS DE MONTAJE, INSTALACIÓN, O SIMILARES, SE CONSIDERAN MUEBLES, ARTÍCULO 423. EXCLUSIÓN DEL IMPUESTO EN EL TERRITORIO INTENDENCIAL DE SAN ANDRÉS Y PROVIDENCIA, ARTÍCULO 424. BIENES QUE NO CAUSAN EL IMPUESTO, ARTÍCULO 425. OTROS BIENES QUE NO CAUSAN EL IMPUESTO, ARTÍCULO 426. SERVICIOS EXCLUIDOS (+105 more)

### Community 43 - "LIBRO PRIMERO - IMPUESTO SOBRE LA RENTA Y COMPLEMENTARIOS"
Cohesion: 0.03
...
Cohesion: 0.05
Nodes (42): ARTÍCULO 514. CONTRIBUYENTES O RESPONSABLES SON SUJETOS PASIVOS, ARTÍCULO 515. QUIÉNES SON CONTRIBUYENTES, ARTÍCULO 516. QUIÉNES SON RESPONSABLES, ARTÍCULO 517, ARTÍCULO 518. AGENTES DE RETENCIÓN, ARTÍCULO 519. REGLA GENERAL DE CAUSACIÓN DEL IMPUESTO Y TARIFA, ARTÍCULO 520, ARTÍCULO 521. DOCUMENTOS PRIVADOS SOMETIDOS AL IMPUESTO DE TIMBRE, CUALQUIERA FUERE SU CUANTÍA (+34 more)

### Community 46 - "LIBRO OCTAVO - (Libro, Sustituido por el Art. 74 de la Ley 2010 de 2019)"
Cohesion: 0.06
Nodes (35): ARTÍCULO 2, ARTÍCULO 3, ARTÍCULO 4, ARTÍCULO 903. CREACIÓN DEL IMPUESTO UNIFICADO BAJO EL RÉGIMEN SIMPLE DE TRIBUTACIÓN - SIMPLE, ARTÍCULO 904. HECHO GENERADOR Y BASE GRAVABLE DEL IMPUESTO UNIFICADO BAJO EL RÉGIMEN SIMPLE DE TRIBUTACIÓN - SIMPLE, ARTÍCULO 905. SUJETOS PASIVOS, ARTÍCULO 906. SUJETOS QUE NO PUEDEN OPTAR POR EL IMPUESTO UNIFICADO BAJO EL RÉGIMEN SIMPLE DE TRIBUTACIÓN - SIMPLE, ARTÍCULO 907. IMPUESTOS QUE COMPRENDEN E INTEGRAN EL IMPUESTO UNIFICADO BAJO EL RÉGIMEN SIMPLE DE TRIBUTACIÓN - SIMPLE (+27 more)

### Community 47 - "AGENTS.md — Protocolo y Directivas para Agentes Autónomos en Fiscol"
Cohesion: 0.07
Nodes (26): 1. Pruebas Unitarias y de Integración (Pytest), 🎯 1. Resumen del Proyecto y Propósito (Why Fiscol Exists), 🛠️ 2. Comandos del Entorno de Desarrollo, 2. Linteo y Formato de Código (Ruff), 🕸️ 3. Navegación de Arquitectura con Graphify (Knowledge Graph), 3. Tipado Estático (Mypy), 🧪 4. Instrucciones de Pruebas y Verificación, 4. Linteo de Documentación (Markdownlint) (+18 more)

### Community 48 - "2. Liquidación de Sanciones (Arts. 641, 644, 647, 648, 640 y 639 E.T.)"
Cohesion: 0.14
...
Cohesion: 0.14
Nodes (13): Common Mistakes, Declaración de Renta Personas Naturales Colombia (Formulario 210), Fase 1: Ingesta y Desglose Documental en CSV (`transacciones_depuradas.csv`), Fase 2: Clasificacion Cedular y Aplicacion de Beneficios, Fase 3: Consolidacion e Inyeccion a la API de Fiscol, Fase 4: Auditoría, Sanciones y Optimización Post-Liquidación, Heuristicas de Clasificacion Documental, Overview (+5 more)
...
Cohesion: 0.25
Nodes (7): 1. Control de Acceso por Sesión (`X-Session-ID`), 2. Inyectar datos en la pantalla en vivo (API ➔ UI), 3. Inyección Automatizada con el Script del Skill, 4. Leer lo que el usuario tiene en pantalla (UI ➔ API), 5. Escuchar eventos en vivo vía Server-Sent Events (SSE), Ejemplo en Python `requests` (para Agentes IA), Guía How-To: Integración API Bidireccional en Tiempo Real (REST, SSE & Redis)

### Community 57 - "2. Scripts Disponibles"
Cohesion: 0.29
Nodes (6): 1. Propósito, 2. Scripts Disponibles, `conciliar_exogena.py`, `consolidar_transacciones.py`, `inyectar_tributia.py`, Skill: `declaracion-renta-persona-natural`

### Community 58 - "Fiscol Colombia — Suite Tributaria & Motor de Liquidación DIAN 2026"
Cohesion: 0.29
Nodes (7): 1. Clonar y ejecutar, 2. Acceso, Características Principales, Documentación Técnica (Diátaxis), Fiscol Colombia — Suite Tributaria & Motor de Liquidación DIAN 2026, Inicio Rápido, Suite de Pruebas Automatizadas

### Community 59 - "1. Tipos de Eventos Transmitidos"
Cohesion: 0.33
Nodes (5): 1. Tipos de Eventos Transmitidos, Evento: `connected`, Evento: `reset`, Evento: `state_update`, Referencia de Eventos SSE (Server-Sent Events)

### Community 60 - "test_articulo_73.py"
Cohesion: 0.40
Nodes (4): test_api_endpoints_articulo_73, test_calcular_ajuste_articulo_73_acciones, test_calcular_ajuste_articulo_73_inmueble_urbano, test_get_tabla_articulo_73_loads_successfully

### Community 61 - "Reglas de Handlers y Endpoints de la API"
Cohesion: 0.40
Nodes (4): 1. FastAPI y Routing, 2. Sincronización Bidireccional y SSE, 3. Manejo de Errores, Reglas de Handlers y Endpoints de la API

### Community 62 - "Reglas del Frontend (React / TypeScript / Vite)"
Cohesion: 0.40
Nodes (4): 1. Stack Tecnológico, 2. Máscara Contable y Entradas, 3. Componentes, Reglas del Frontend (React / TypeScript / Vite)

### Community 63 - "Reglas del Motor de Liquidación Tributaria (Tax Engine)"
Cohesion: 0.40
...
### Community 64 - "test_comparacion_patrimonial.py"
Cohesion: 0.33
...
Cohesion: 0.40
Nodes (4): 1. Principios de Diseño, 2. Diagrama de Arquitectura Global, 3. Manejo de Concurrencia y Resiliencia en Frontend, Explicación: Arquitectura del Sistema Fiscol

### Community 68 - "Reglas de Documentación"
Cohesion: 0.50
Nodes (3): 1. Estándar Diataxis, 2. Conformidad con Markdownlint, Reglas de Documentación

### Community 69 - "Reglas de Modelos y Esquemas Pydantic"
Cohesion: 0.50
Nodes (3): 1. Validación Estricta, 2. Tipado Estático y Mypy, Reglas de Modelos y Esquemas Pydantic

### Community 70 - "Reglas de Skills y Agentes Autónomos"
Cohesion: 0.50
...
Cohesion: 0.50
Nodes (3): 1. Algoritmo DIAN Módulo 11 (Cálculo de DV), Casos Oficiales de Prueba, Guía How-To: Consultar Vencimientos por NIT y Calendario DIAN

### Community 76 - "Arquitectura C4 — Fiscol"
Cohesion: 0.40
Nodes (4): 1. Nivel 1: Diagrama de Contexto del Sistema (C1), 2. Nivel 2: Diagrama de Contenedores (C2), 3. Nivel 3: Diagrama de Componentes del Backend (C3), Arquitectura C4 — Fiscol

### Community 77 - "React + TypeScript + Vite"
Cohesion: 0.50
Nodes (3): Expanding the Oxlint configuration, React Compiler, React + TypeScript + Vite

### Community 79 - "test_componente_inflacionario.py"
Cohesion: 0.25
...
Cohesion: 0.33
Nodes (5): 1. La Unidad de Valor Tributario (UVT), 2. Patrimonio: Bruto vs. Líquido vs. Deudas, 3. Depuración Cedular & El Límite del 40% (1.340 UVT), 4. Régimen Sancionatorio & Beneficio de Auditoría, Glosario & Guía de Conceptos Básicos Tributarios (Estatuto Tributario de Colombia)

### Community 148 - "Especificación de Diseño: Landing Page y Hub de Instalación de Skills de IA en TributIA"
Cohesion: 0.17
Nodes (11): 1. Resumen Ejecutivo y Propósito, 2.1 Modelo de Vistas en `AppContext`, 2.2 Sincronización de Hash URL (`window.location.hash`), 2.3 Navegación Bidireccional, 2. Arquitectura de Navegación y Estado, 3.1 `LandingPage.tsx`, 3.2 `SkillTutorialPage.tsx`, 3. Componentes y Contenido Visual (+3 more)

### Community 149 - "models/regimen_simple.py"
Cohesion: 0.33
Nodes (5): ComparativaSimpleInput, ComparativaSimpleOutput, Formulario260Casillas, RegimenSimpleInput, RegimenSimpleOutput

### Community 150 - "Plugin: `fiscol-tax-assistant`"
Cohesion: 0.40
Nodes (4): 1. Estructura del Plugin, 2. Habilidades (*Skills*) Incluidas, 3. Instalación e Invocación, Plugin: `fiscol-tax-assistant`
...
### Community 152 - "liquidacion_simple.py"
Cohesion: 0.40
Nodes (4): comparar_ordinario_vs_simple, _get_nombre_grupo, _get_tarifa_simple, liquidar_regimen_simple

### Community 153 - "test_simple_calculator.py"
Cohesion: 0.50
Nodes (3): test_comparativa_ordinario_vs_simple, test_regimen_simple_grupo1_tiendas, test_regimen_simple_grupo3_restaurante_con_inc

### Community 154 - "test_coverage_pj_simple_boost.py"
Cohesion: 0.29
...
### Community 159 - "endpoints/beneficios.py"
Cohesion: 0.17
Nodes (11): liquidar_sancion, listar_beneficios, obtener_tabla_articulo_73, obtener_tabla_componente_inflacionario, simular_articulo_73, simular_auditoria, simular_combinabilidad_endpoint, simular_componente_inflacionario_endpoint (+3 more)

### Community 160 - "router.py"
Cohesion: 0.22
Nodes (5): calcular_renta_persona_juridica, calcular_comparacion_patrimonial_endpoint, calcular_renta_persona_natural, calcular_regimen_simple, simular_comparativa_regimen

### Community 161 - "Cómo Realizar la Planeación Tributaria en Pareja & Manejo de Bienes Compartidos (Arts. 8, 119, 236, 241, 302 y 387 E.T.)"
Cohesion: 0.22
Nodes (8): 1. La Regla de Oro: Individualidad Fiscal (Art. 8 E.T.), 2. Diagnóstico de Riesgos: "¿Qué pasa si uno pone la plata y el bien queda a nombre del otro?", 3. Estrategias Maestras de Optimización, 4. Ejemplo de Uso vía API REST, Cómo Realizar la Planeación Tributaria en Pareja & Manejo de Bienes Compartidos (Arts. 8, 119, 236, 241, 302 y 387 E.T.), Petición HTTP (`POST /api/v1/beneficios/simular-tributacion-pareja`), Respuesta, 🛡️ Soluciones Jurídicas Válidas

### Community 162 - "session_sync.py"
Cohesion: 0.25
Nodes (7): event_generator, get_current_session_info, get_session_state, reset_session, resolve_session_id, session_events_stream, update_session_state

### Community 163 - "models/tributacion_pareja.py"
Cohesion: 0.29
...
### Community 164 - "test_tributacion_pareja.py"
Cohesion: 0.40
Nodes (4): test_endpoint_simular_tributacion_pareja, test_simular_tributacion_pareja_copropiedad_50_50, test_simular_tributacion_pareja_mutuo_prestamo, test_simular_tributacion_pareja_riesgo_desajuste_patrimonial

### Community 165 - "simulation.py"
Cohesion: 0.50
Nodes (3): ScenarioComparisonRequest, ScenarioComparisonResponse, comparar_escenarios_pn

### Community 166 - "services/tributacion_pareja.py"
Cohesion: 0.50
Nodes (3): _calcular_impuesto_tabla_241, _liquidar_conyuge_individual, simular_tributacion_pareja

### Community 167 - "models/iva.py"
Cohesion: 0.29
Nodes (6): BienServicioIvaItem, Formulario300Casillas, IvaF300Input, IvaF300Output, IvaProrrateoInput, IvaProrrateoOutput

### Community 168 - "models/retefuente.py"
Cohesion: 0.29
Nodes (6): Formulario350Casillas, RetefuenteF350Input, RetefuenteF350Output, RetefuenteLaboralInput, RetefuenteLaboralOutput, TablaRetefuenteItem
...
### Community 173 - "liquidacion_retefuente.py"
Cohesion: 0.33
Nodes (5): calcular_formulario_350, calcular_retefuente_laboral_art383, _make_item, _nombre_mes, obtener_tabla_maestra_retefuente

### Community 174 - "test_iva_calculator.py"
Cohesion: 0.33
Nodes (5): test_api_endpoints_iva, test_clasificador_bienes_servicios, test_iva_f300_saldo_a_favor, test_iva_f300_saldo_a_pagar, test_iva_prorrateo_art490_calculo
...
### Community 176 - "analizar_comparacion.py"
Cohesion: 0.50
Nodes (3): analizar_borrador_f210, cargar_cuestionario_diagnostico, main

### Community 177 - "test_retefuente_calculator.py"
Cohesion: 0.33
Nodes (5): test_api_endpoints_retefuente, test_retefuente_f350_liquidacion_completa, test_retefuente_laboral_salario_alto_con_retencion_y_deducciones, test_retefuente_laboral_salario_bajo_sin_retencion, test_tabla_maestra_retenciones

### Community 178 - "extraer_f210_borrador.py"
Cohesion: 0.50
Nodes (3): extraer_datos_borrador, extraer_datos_desde_pdf, main

### Community 181 - "liquidacion_iva.py"
Cohesion: 0.40
Nodes (4): calcular_formulario_300, calcular_prorrateo_iva_art490, _nombre_periodo, obtener_clasificador_bienes_servicios_iva

### Community 182 - "endpoints/iva.py"
Cohesion: 0.50
Nodes (3): calculate_formulario_300, calculate_prorrateo_art490, get_clasificador_iva

### Community 183 - "endpoints/retefuente.py"
Cohesion: 0.50
Nodes (3): calculate_formulario_350, calculate_retefuente_laboral, get_tabla_retenciones

### Community 184 - "rules.py"
Cohesion: 0.50
Nodes (3): convertir_uvt, listar_anos, obtener_reglas_ano
...
### Community 186 - "02-simular-tasa-minima-ttd-pj.md"
Cohesion: 0.50
...
### Community 187 - "Estatuto Tributario Nacional de Colombia"
Cohesion: 0.29
