...
class BeneficioItem(BaseModel):
    id: str
    categoria: str # "incrngo", "deducciones", "rentas_exentas", "descuentos", "auditoria_sanciones"
    nombre: str
    articulo_et: str
    descripcion: str
...
class BeneficioAuditoriaRequest(BaseModel):
    ...
    impuesto_neto_ano_anterior: float = Field(..., description="Impuesto neto de renta liquidado en la declaración del año anterior (Casilla 112 F210)")
...
class ReduccionSancionRequest(BaseModel):
    monto_sancion_base_cop: float = Field(..., description="Monto base de la sanción liquidada (ej. 10% del mayor valor por corrección Art. 644)")
    sin_sanciones_ultimos_2_anos: bool = Field(True, description="¿No ha sido sancionado por la DIAN en los últimos 2 años? (Aplica reducción al 50% Art. 640)")
    sin_sanciones_ultimo_1_ano: bool = Field(True, description="¿No ha sido sancionado por la DIAN en el último año? (Aplica reducción al 75% Art. 640)")
...
def get_catalogo_beneficios() -> List[BeneficioItem]:
    return [
        ...
        BeneficioItem(
            ...
            requisitos=["Hijos menores de 18 años, hijos hasta 23 años que estudien, cónyuge o padres con dependencia económica certificada."],
        ...
        BeneficioItem(
            ...
            requisitos=["Certificados de registro civil y dependencia de hasta 4 dependientes adicionales."],
        ...
        BeneficioItem(
            ...
            requisitos=["Certificado anual de pagos emitido por la entidad de medicina prepagada o aseguradora."],
        ...
        BeneficioItem(
            ...
            requisitos=["Certificado tributario expedido por el banco o entidad financiera acreedora."],
        ...
        BeneficioItem(
            ...
            requisitos=["Factura electrónica a nombre del declarante, pagada por tarjeta débito/crédito o transferencia."],
        ...
        BeneficioItem(
            ...
            requisitos=["Permanencia mínima de 10 años en el fondo o retiro para compra de vivienda o pensión."],
        ...
        BeneficioItem(
            ...
            requisitos=["Ser perceptor de rentas de trabajo (laborales o independientes que no imputen costos)."],
        ...
        BeneficioItem(
            ...
            requisitos=["Corregir voluntariamente y liquidar la sanción reducida junto con los intereses de mora."],
