...
CSV_DEMO_ROWS = (
    "1,2026-01-30,Certificado_Ingresos_Retenciones_220.pdf,EMPRESA TECNOLOGIA SAS,900123456-1,Salarios y pagos laborales devengados,INGRESO,120000000,TRABAJO,SALARIO,Art. 103 E.T.,ALTA,Casilla 37 Formulario 220,MATCH_EXACTO,120000000,0,CONFIRMADO_CERTIFICADO\n"
    "2,2026-01-30,Certificado_Ingresos_Retenciones_220.pdf,EPS SURA,800088702-2,Aportes obligatorios a salud (4%),EGRESO,4800000,TRABAJO,INCRNGO_SALUD,Art. 56 E.T.,ALTA,Casilla 49 Formulario 220,MATCH_EXACTO,4800000,0,CONFIRMADO_CERTIFICADO\n"
    "3,2026-01-30,Certificado_Ingresos_Retenciones_220.pdf,PROTECCION PENSIONES,800229739-0,Aportes obligatorios a pension (4%),EGRESO,4800000,TRABAJO,INCRNGO_PENSION,Art. 55 E.T.,ALTA,Casilla 50 Formulario 220,MATCH_EXACTO,4800000,0,CONFIRMADO_CERTIFICADO\n"
    "4,2026-01-30,Certificado_Ingresos_Retenciones_220.pdf,EMPRESA TECNOLOGIA SAS,900123456-1,Retenciones en la fuente practicadas en el ano,RETENCION,5000000,TRABAJO,RETENCION_FUENTE,Art. 383 E.T.,ALTA,Casilla 53 Formulario 220,MATCH_EXACTO,5000000,0,CONFIRMADO_CERTIFICADO\n"
    "5,2026-12-15,Certificado_Credito_Hipotecario_Bancolombia.pdf,BANCOLOMBIA SA,890903938-8,Intereses pagados por credito de vivienda principal,EGRESO,12000000,TRABAJO,DED_VIVIENDA,Art. 119 E.T.,ALTA,Deduccion imputable con tope 1.200 UVT,MATCH_EXACTO,12000000,0,CONFIRMADO_CERTIFICADO\n"
    "6,2026-12-20,Certificado_Medicina_Prepagada_Colsanitas.pdf,COLSANITAS SA,860072049-1,Pagos por plan complementario de salud,EGRESO,6000000,TRABAJO,DED_PREPAGADA,Art. 387 E.T.,ALTA,Deduccion imputable con tope 192 UVT,SOLO_EN_CERTIFICADOS,0,6000000,CONFIRMADO_CERTIFICADO\n"
    "7,2026-12-31,Certificado_Tributario_Cta_Ahorros_Bancolombia.pdf,BANCOLOMBIA SA,890903938-8,Saldo en cuenta de ahorros a 31 de diciembre,PATRIMONIO_ACTIVO,45000000,PATRIMONIO,PATRIMONIO_CUENTAS,Art. 261 E.T.,ALTA,Saldo liquido bancario a fin de ano,MATCH_EXACTO,45000000,0,CONFIRMADO_CERTIFICADO\n"
    "8,2026-12-31,Certificado_Credito_Hipotecario_Bancolombia.pdf,BANCOLOMBIA SA,890903938-8,Saldo de deuda hipotecaria a 31 de diciembre,PATRIMONIO_PASIVO,80000000,PATRIMONIO,DEUDA_HIPOTECARIA,Art. 283 E.T.,ALTA,Pasivo soportado fiscalmente,MATCH_EXACTO,80000000,0,CONFIRMADO_CERTIFICADO\n"
)
