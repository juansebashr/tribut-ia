...
@pytest.mark.anyio
async def test_redis_session_store_pubsub_broadcast():
    ...
    await store.update_state("test_pubsub", {"metadata": {"nombre": "TEST BROKER"}}, source="api")
