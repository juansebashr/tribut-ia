...
def test_api_pn_full_35pct_bracket_cycle():
    ...
    assert data["form_210_casillas"]["c39_renta_liquida_gravable_trabajo"] == data["renta_liquida_gravable"]
    assert data["form_210_casillas"]["c108_impuesto_rentas_liquidas_gravables"] == data["impuesto_bruto_renta"]
